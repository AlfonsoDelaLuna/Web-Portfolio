...
import "./Transaction_ManagementInfoPage.css";
...
const TransactionManagementInfoPage = ({ project }) => {
  if (!project) {
        ...
        <div className="clinic-slider-wrapper">
          <Slider {...sliderSettings}>
            <div className="slide-item">
              <img src="/images/Transaction_bg.png" alt="Login" />
            </div>
          </Slider>
        </div>
      </main>
...
export default TransactionManagementInfoPage;
