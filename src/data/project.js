...
const projectsData = [
  ...
  { // Drugstore Management System
    ...
    problem: 'The major problems observed in the current inventory process are:',
    problem1: 'Paper-based inventory process – Manual recording makes stock monitoring inefficient, disorganized, and prone to damage or loss.',
    problem2: 'Incorrect information recording – Errors in writing product details (such as quantity, supplier, or expiration date) result in unreliable data.',
    problem3: 'Difficulty in monitoring stock levels – Without a centralized system, tracking available products becomes time-consuming and may lead to delays in serving customers.',
    problem4: 'Inability to properly track expiration dates – Medicines may remain unsupervised until expired, leading to waste and potential health risks.',
    problem5: 'Lack of accurate reports for decision-making – Generating reliable reports manually is tedious, limiting the ability to make informed inventory and business decisions.',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL'],
  ...
  { // Guidance Management System
    ...
    problem: 'These are the problems faced prior of the development of the Guidance Management System:',
    problem1: 'Some students may have difficulty accessing or completing the online form due to limited internet access or lack of technical skills.',
    problem2: 'Risk of data breaches or unauthorized access if information is not stored securely on PCs or physical files.',
    problem3: 'Incomplete or inaccurate information submitted by students, making records unreliable.',
    problem4: 'Mismanagement or loss of physical forms in storage.',
    problem5: 'Delays in retrieving student information when addressing issues such as academics, bullying, or violations.',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL'],
    githubRepoLink: 'https://github.com/AlfonsoDelaLuna/Guidance_System',
  ...
  { //Library Management System
    ...
    problem: 'These are the 5 main problems faced in the library management system:',
    problem1: "Library management system malfunction – Inaccurate storage of student numbers in the admin's Excel file compromises data integrity.",
    problem2: 'Paper-based authentication system introduced – Manual recording leads to inefficiencies, inaccuracies, and increased risk of data loss.',
    problem3: 'User feedback received – Frustration with system errors highlighted the need for an operational change.',
    problem4: 'Log-out feature removed – Eliminating this feature reduces queues during lunch breaks and closing times.',
    problem5: 'Staff training conducted – Ensured a smooth transition to the new paper-based system while addressing technical issues.',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL'],
